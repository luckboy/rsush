...
mod tests
{
    ...
    fn test_exit_builtin_function_quits()
    {
        ...
        exec.clear_files();
        assert_eq!(0, status);
        assert!(interp.has_exit_with(true));
    ...
    #[sealed_test(before=setup(), after=teardown())]
    fn test_exit_builtin_function_quits_with_other_status()
    {
        let mut exec = Executor::new();
        let mut interp = Interpreter::new();
        let mut env = Environment::new();
    ...
    #[sealed_test(before=setup(), after=teardown())]
    fn test_exit_builtin_function_complains_on_too_many_arguments()
    {
        let mut exec = Executor::new();
        let mut interp = Interpreter::new();
        let mut env = Environment::new();
    ...
    #[sealed_test(before=setup(), after=teardown())]
    fn test_exit_builtin_function_complains_on_invalid_number()
    {
        let mut exec = Executor::new();
        let mut interp = Interpreter::new();
        let mut env = Environment::new();
