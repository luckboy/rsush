...
mod tests
{
    ...
    fn test_break_builtin_function_breaks()
    {
        ...
        exec.clear_files();
        assert_eq!(0, status);
        assert!(interp.has_break_with(1));
    ...
    #[sealed_test(before=setup(), after=teardown())]
    fn test_break_builtin_function_doubly_breaks()
    {
        let mut exec = Executor::new();
        let mut interp = Interpreter::new();
        let mut env = Environment::new();
        ...
        exec.clear_files();
        assert_eq!(0, status);
        assert!(interp.has_break_with(2));
        assert_eq!(false, interp.exec_redirect_flag());
        assert_eq!(String::new(), read_file("stdout.txt"));
        assert_eq!(String::new(), read_file("stderr.txt"));
        assert_eq!(String::new(), read_file("stderr2.txt"));
    ...
    #[sealed_test(before=setup(), after=teardown())]
    fn test_break_builtin_function_complains_on_is_not_in_loop()
    {
        let mut exec = Executor::new();
        let mut interp = Interpreter::new();
        let mut env = Environment::new();
    ...
    #[sealed_test(before=setup(), after=teardown())]
    fn test_break_builtin_function_complains_on_too_many_arguments()
    {
        let mut exec = Executor::new();
        let mut interp = Interpreter::new();
        let mut env = Environment::new();
    ...
    #[sealed_test(before=setup(), after=teardown())]
    fn test_break_builtin_function_complains_on_invalid_number()
    {
        let mut exec = Executor::new();
        let mut interp = Interpreter::new();
        let mut env = Environment::new();
    ...
    #[sealed_test(before=setup(), after=teardown())]
    fn test_break_builtin_function_complains_on_illegal_number()
    {
        let mut exec = Executor::new();
        let mut interp = Interpreter::new();
        let mut env = Environment::new();
